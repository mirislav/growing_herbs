package net.mcreator.growingherbs;
...
import net.mcreator.growingherbs.init.GrowingHerbsModTabs;
...
@Mod("growing_herbs")
public class GrowingHerbsMod {
	public static final Logger LOGGER = LogManager.getLogger(GrowingHerbsMod.class);
	public static final String MODID = "growing_herbs";

	public GrowingHerbsMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		GrowingHerbsModBlocks.REGISTRY.register(modEventBus);
		GrowingHerbsModItems.REGISTRY.register(modEventBus);
		GrowingHerbsModTabs.REGISTRY.register(modEventBus);
