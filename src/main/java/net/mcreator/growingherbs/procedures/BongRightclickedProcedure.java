...
public class BongRightclickedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (hasEntityInInventory(entity, new ItemStack(GrowingHerbsModItems.BUD.get())) && hasEntityInInventory(entity, new ItemStack(GrowingHerbsModItems.LIGHTER.get()))) {
			...
			if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide())
				_entity.addEffect(new MobEffectInstance(MobEffects.RESISTANCE, 300, 1, false, false));
			...
			new ItemStack(GrowingHerbsModItems.BUD.get()).shrink(1);
		}
	}
